...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    company: "The StrataMinds",
    description: `Promoted to Junior Frontend Developer following a successful internship, where I now contribute to the design and development of dynamic web applications using React and Next.js. Collaborate with designers and backend developers to implement responsive and intuitive user interfaces that enhance user engagement and satisfaction. Currently utilizing Aceternity-UI to create consistent and visually appealing components, ensuring a seamless experience across different devices and platforms. Actively participate in code reviews, providing constructive feedback to peers while continuously improving my own coding skills and knowledge of best practices.`,
    technologies: [
      "React",
      "NextJS",
      "Aceternity-UI",
...
export const PROJECTS = [
  {
    ...
    technologies: ["NextJS", "Express", "Node.js", "MongoDB"],
  },
  {
